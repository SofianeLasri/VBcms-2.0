...
<div class="page-content" leftSidebar="240" rightSidebar="0">
	...
	<div id="includeGallery">
		...
		<?php require $_SERVER['DOCUMENT_ROOT']."/vbcms-content/modules/gallery/admin/gallery-htmlOnly.php"; ?>
	</div>
...
<?php require $_SERVER['DOCUMENT_ROOT']."/vbcms-content/modules/gallery/admin/gallery-scriptOnly.php"; ?>